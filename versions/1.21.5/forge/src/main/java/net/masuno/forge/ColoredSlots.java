...
public class ColoredSlots {
	public ColoredSlots(FMLJavaModLoadingContext context) {
		...
		MinecraftForge.EVENT_BUS.addListener(ColoredSlots::registerClientCommands);
		context.getModEventBus().addListener(ColoredSlots::registerKeyMappings);
		MinecraftForge.EVENT_BUS.addListener(ColoredSlots::onClientTick);
	}
